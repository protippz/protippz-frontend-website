...
function ConnectionBoth() {
  return (
    <section className="relative w-full bg-[#F6F8FA]">
      {/* Silk top border */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-[#57606A] text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
            Tip and earn rewards — our fan rewards program recognizes your contributions. From exclusive gifts to personalized recognition, keep supporting our favorite female athletes.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center px-8 py-12 sm:px-10 sm:py-14 lg:px-14 lg:py-16">
              ...
              <h3 className="text-2xl font-e sm:text-3xl lg:text-[2.15rem] font-black text-[#1A2A23] leading-[1.15] tracking-[-0.025em] mb-4">
                ...
                <span className="text-[#308D6F]">female athletes</span>{' '}
                they love
              </h3>

              <p className="text-[#57606A] text-sm sm:text-base leading-relaxed mb-8 max-w-md">
                Where fan passion meets athlete support — helping you make a real
                difference, one tip at a time, while earning exclusive rewards along
                the way.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  style={{ background: '#308D6F' }}
                >
                  Start tipping
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                    <path d="M2 6h8M6 2.5L9.5 6 6 9.5" stroke="white" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </button>
                ...
                <button
                  ...
                  style={{ borderColor: '#D0D7DE', color: '#1A2A23' }}
                >
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" className="text-[#154098]">
            ...
            <div className="relative min-h-[300px] sm:min-h-[400px] lg:min-h-[540px] bg-[#F6F8FA]">
              ...
              >
                <span
                  className="w-2 h-2 rounded-full bg-[#308D6F] animate-pulse"
                  aria-hidden="true"
                />
                <span className="text-xs font-semibold text-[#1A2A23]">Live tips flowing</span>
              </div>
            </div>
