...
function TopHero() {
  ...
  return (
    <section className="w-full max-w-full bg-[#228c6b] select-none overflow-hidden">
      ...
      <div className="flex flex-col md:hidden">
        ...
        <div className="flex gap-2 px-6 pb-4">
          <button
            onClick={() => scroll("left")}
            className="w-9 h-9 rounded-full bg-white/15 hover:bg-white/25 active:scale-95 transition-all flex items-center justify-center text-white cursor-pointer"
      ...
      <div className="hidden md:flex items-stretch py-8 w-full max-w-full overflow-hidden">
        {/* Left panel — fixed width, never scrolls */}
        <div className="shrink-0 w-80 lg:w-96 flex flex-col justify-end px-8 pb-2 gap-4">
          <div>
            <h1 className="text-white font-e text-4xl font-black tracking-tight leading-tight">
              The Faces of
              <br />
              Women&apos;s Athletes
            </h1>
