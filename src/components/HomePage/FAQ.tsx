...
function FAQItem({
  ...
  return (
    ...
    >
      ...
      >
        <div className="px-6 pb-5 border-t" style={{ borderColor: 'rgba(42,146,109,0.12)' }}>
          <p className="text-sm text-[#57606A] leading-relaxed pt-4">{answer}</p>
        </div>
      </div>
    </div>
  )
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-e sm:text-5xl font-black text-[#1A2A23] mb-4 leading-[1.1] tracking-[-0.03em]">
            Frequently asked{' '}
            <span className="text-[#308D6F]">questions</span>
          </h2>

          <p className="text-[#57606A] text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            Everything you need to know about PROTIPPZ — from sending your first tip
            to unlocking exclusive fan rewards.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1">
          ...
          <div className="lg:col-span-9 flex flex-col gap-10">
            {faqs.map(section => (
              <div key={section.category} id={`faq-${section.category.toLowerCase().replace(/\s+/g, '-')}`}>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1 h-px" style={{ background: '#D0D7DE' }} />
                </div>
