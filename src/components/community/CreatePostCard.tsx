  ...
  return (
    <div
      ...
      style={{
        ...
        border: '2px solid #2FC19140',
        boxShadow: '0 4px 20px rgba(5,54,151,0.06)',
      }}
    >
      {/* Header */}
      ...
      {/* Actions and Buttons */}
      {showCreatePost && (
        <div className="mt-4 space-y-3 pt-3 border-t border-[#0536970F]">
          <div className="flex items-center gap-2 flex-wrap">
            <button
              onClick={() => postImageRef.current?.click()}
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold transition-all hover:bg-[#0536970B] active:scale-95"
              style={{ backgroundColor: '#0536970F', color: '#053697' }}
            >
